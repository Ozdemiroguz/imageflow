...
class HistoryRepositoryImpl implements HistoryRepository {
  ...
  static const _tag = 'HistoryRepository';

  final Box<ProcessingHistoryModel> _box;
  final FileService _fileService;

  @override
  Future<Result<List<ProcessingHistory>>> getAll() => Result.guard(
    () async {
  ...
  @override
  Future<Result<void>> save(ProcessingHistory history) => Result.guard(
    () async {
  ...
  static void _logStorageError(Object error, StackTrace stackTrace) {
    Log.error(
